...
A multi-task learning approach to person re-identification and attribute recognition. Written in PyTorch, trained and evaluated on the [Market-1501](https://github.com/vana77/Market-1501_Attribute) dataset. Check the [report](./report.pdf) for more implementation details.
